...
train_data, train_act_data, train_emo_data = load_data('C:\Users\Vinay\OneDrive\Documents\GitHub\Coordination\ijcnlp_dailydialog', 'train')
test_data, test_act_data, test_emo_data = load_data('C:\Users\Vinay\OneDrive\Documents\GitHub\Coordination\ijcnlp_dailydialog', 'test')
val_data, val_act_data, val_emo_data = load_data('C:\Users\Vinay\OneDrive\Documents\GitHub\Coordination\ijcnlp_dailydialog', 'validation')
...
def pr_data(mode):
    ...
    data_file = os.path.join('C:\Users\Vinay\OneDrive\Documents\GitHub\Coordination\ijcnlp_dailydialog', '{}/dialogues_politeness_{}.txt'.format(mode, mode))
    f = open(data_file, 'w')
